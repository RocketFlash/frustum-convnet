...
from waymo.prepare_data_waymo import extract_frustum_data, extract_pc, extract_image
...
class ProviderDataset(Dataset):
    ...
    def __init__(self, npoints=1024, data_idxs_list=None, datasets=None,
        ...
        self.lidar_points_threshold = lidar_points_threshold
        ...
        self.data_idxs_list = data_idxs_list
...
class ProviderDatasetSingleFrame(Dataset):
    def __init__(self, npoints, 
                 lidar_points_threshold=5,
                 classes = ['car']):

        super(ProviderDatasetSingleFrame, self).__init__(npoints=npoints,
    ...
    def __getitem__(self, tfrecord_file_name, frame_idx):
        datas = self.get_frustum_data(tfrecord_file_name, frame_idx)
